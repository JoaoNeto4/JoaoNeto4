...
Analista de Sistemas e Desenvolvedor focado na construção de arquiteturas corporativas, desenvolvimento backend e frontend, integração de ecossistemas de gestão (ERP) e automação de infraestrutura em ambientes Linux/DevOps.
